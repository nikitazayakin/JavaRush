...
public class Solution {
    ...
    /**Статики не на своем месте
     ...
     Послышались мелкие шаги, и в комнате появился мастер Ю Ву, специалист по
     расстановке. Хмуро он посмотрел на код, и сказал то, что боялся услышать
     программист: «Статики не там, гдеони нужны. Вот в чем ошибка твоя». Мастер
     прав: расставьте модификаторы static так, чтобы программа скомпиллировалась.
     *
     * Статики не на своем месте
