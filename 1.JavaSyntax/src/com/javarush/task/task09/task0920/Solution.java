...
public class Solution {
    ...
    /**     Обратный отсчёт
     ...
     На контрольной работе в секретном центре JavaRush студентам дали задание: написать
     обратный отсчёт от 10 до 0, чтобы определить, сколько времени осталось до конца этой
     самой контрольной работы. Правда, классно? Для задержки нужно использовать Thread.sleep(100),
     а вызов sleep обернуть в try..catch. Время пошло!
     *
     * Обратный отсчёт
