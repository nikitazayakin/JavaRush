...
public class Solution {
    ...
    /**Перехват выборочных исключений
     ...
     деле исключения — это просто, и это одна из самих ценных вещей в Java. На 9 уровне в
     это вертися с трудом, всё-таки работа с ними с непривычки кажется очень запутанной.
     Без страха, вперёд: в этой задаче вам нужно будет разобраться с перехватом выборочных
     исключений.
     *
     * Перехват выборочных исключений
