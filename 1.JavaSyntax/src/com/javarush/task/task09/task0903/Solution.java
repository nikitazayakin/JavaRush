...
public class Solution {
    ...
    /**Кто меня вызывал?
     ...
     Стек вызовов, может, не самая красивая конструкция… Хотя почему нет? Он логичен, к нему
     просто привыкнуть нужно. Привыкаем с задачами! В этот раз вам нужно написать пять методов,
     которые вызывают друг друга. Метод должен вернуть номер строки кода, из которого вызвали этот
     метод. Для этого воспользуйтесь функцией: element.getLineNumber().
     *
     * Кто меня вызывал?
