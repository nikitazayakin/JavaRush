...
public class Solution {
    ...
    /**Перехват unchecked-исключений
     ...
     Их перехватывать не обязательно, ибо они — unchecked! Они загадочны, их появление трудно
     спрогнозировать и указывать в throws их не нужно», — гласит писание лекций JavaRush. Пришла
     пора: обработайте все unchecked-исключения в методе processExceptions.
     *
     * Перехват unchecked-исключений
