...
public class Solution {
    ...
    /**Группа перехвата исключений
     ...
     Есть 3 исключения, последовательно унаследованные от Exception (Exception1 extends Exception,
     Exception2 extends Exception1 и Exception3 extends Exception2). В программе вы найдете метод
     public static void method1() throws Exception1, Exception2, Exception3. Задача: написать ловца
     catch, который перехватит все три Exception1, Exception2 и Exception3.
     *
     * Группа перехвата исключений
