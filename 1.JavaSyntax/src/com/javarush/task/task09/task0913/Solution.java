...
public class Solution {
    ...
    /**Исключения. Просто исключения.
     ...
     У нас есть метод. Он выбрасывает два исключения, унаследованные от Exception, и два
     унаследованных от RuntimeException: NullPointerException, ArithmeticException,
     FileNotFoundException, URISyntaxException. Задание: перехват NullPointerException и
     FileNotFoundException, без перехвата ArithmeticException и URISyntaxException. Как
     это сделать?
