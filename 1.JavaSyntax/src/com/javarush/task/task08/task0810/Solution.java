...
public class Solution {
    ...
    /**Время для 10 тысяч вызовов get
     ...
     Много ли времени и усилий вы готовы потратить, чтобы получить какое-либо благо? Думаем,
     достаточно, вы же пытаетесь стать программистом прямо сейчас? Давайте посмотрим, сколько
     времени занимает 10 тысяч вызовов get для списков LinkedList и ArrayList. Метод getTimeMsOfGet
     ...
     * Время для 10 тысяч вызовов get
     ...
     7. Метод getTimeMsOfGet должен вернуть время в миллисекундах, которое занимает 10 тысяч вызовов
     get для списка.*/
