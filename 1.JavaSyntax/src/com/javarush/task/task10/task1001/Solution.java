...
public class Solution {
    ...
    /**Задача №1 на преобразование целых типов
     ...
     С этой задачи начинается цикл задач на преобразование целых типов. Это не очень сложная тема,
     но новички в ней часто путаются, поскольку им её суют порой на самих первых порах, что в корне
     неправильно. Вот на 10 уровне — вы готовы. Расставьте правильно операторы приведения типа,
