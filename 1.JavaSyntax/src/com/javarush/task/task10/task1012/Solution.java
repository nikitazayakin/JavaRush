...
public class Solution {
    ...
    /**Количество букв
     ...
     4. Каждая строка вывода должна содержать букву русского алфавита, пробел и
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (char ch: alphabet) {
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                char[] chArray = list.get(i).toCharArray();

                for (char ch2: chArray) {
                    if (ch == ch2) {
                        count++;
                    }
                }
        ...
        ///printing all the numbers of letters
        for (int i = 0; i < abcArray.length; i++) {
