...
public class Solution {
    ...
    /** Задача №7 на преобразование целых типов
     ...
     Седьмая задача цикла «Преобразование целых типов» — финальная. Для начала хватит и семи.
     В ней вы не найдете ничего оригинального, зато получите знания. Итак, есть код, а в нем — много
     операторов приведения типов. Уберите лишние и будьте счастливы! Этот цикл подготовил профессор
     Нуддлз, специально для учебного центра JavaRush. Не забрасывайте учёбу.
     *
     * Задача №7 на преобразование целых типов
     ...
     7. Начальное значение переменных при инициализации менять нельзя. Можно добавлять только
