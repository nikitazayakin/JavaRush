...
public class Solution {
    ...
    /**Задача №2 на преобразование целых типов
     ...
     Вторая задача цикла «Преобразование целых типов» на первый вигляд не слишком
     отличается от предыдущей. Так и задумано, этот цикл создан специально для
     «набивания руки» и параллельного внедрения в мозг правил преобразования типов
     в Java. Расставьте правильно операторы приведения типа, чтобы получился ответ:
     d = 3.765. Операторы — в условии.
     *
     * Задача №2 на преобразование целых типов
