...
public class Solution {
    ...
    /**Задача №6 на преобразование целых типов
     ...
     Вот и шестая задача цикла «Преобразование целых типов» подоспела. Мы тут почему стараемся?
     Хотим, чтобы вы усвоили эти приемы так, чтобы не приходилось переучиваться. В этот раз в
     нашей задаче операторов приведения типов слишком много, затесались лишние. Найдите их и
     уберите, чтобы получить требуемый ответ.
     *
     * Задача №6 на преобразование целых типов
     ...
     10. Начальное значение переменных при инициализации менять нельзя. Можно добавлять только
