...
public class Solution {
    ...
    /** Method takes Integer as a parameter, compares it to number 5 and
     * outputs text about whether a is bigger, smaller or equal to 5.
     *
     * @param a integer will be compared to 5
     */
