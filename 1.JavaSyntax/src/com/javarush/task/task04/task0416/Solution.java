...
public class Solution {
    ...
    /**Переходим дорогу вслепую
     ...
     Ввести с клавиатуры вещественное число t, означающее время в минутах, прошедшее с
     начала очередного часа.
    ...
    public static void main(String[] args) throws Exception {
        ...
        getTrafficLight(minute);
    }

    /** returns current color of traffic light for current minute.
     * Работа светофора для пешеходов запрограммирована следующим образом:
     в начале каждого часа в течение трех минут горит зелёный сигнал,
     затем в течение одной минуты — жёлтый,
     а потом в течение одной минуты — красный,
     затем опять зелёный горит три минуты и т. д.
     *
     * @param minute minute in double format
     */
    public static void getTrafficLight(double minute) {

        double remainder = minute % 5;
