...
public class Solution {
    ...
    /** Bingo!
     ...
     Всякий тигр — кот чуть более, чем полностью. А кот — это домашний питомец. Ну а любой
     домашний питомец в свою очередь является животным. И все они произошли от Object. В нашей
     программе что-то не так с наследованием. Исправьте строку ‘Object animal = new Pet();‘
     ...
     3. В переменной Object animal должен храниться объект который будет одновременно являться и
     Pet, и Cat, и Tiger.
