...
public class Solution {
    ...
    /**Скрытный инкапсулированный кот
     ...
     В лекции по инкапсуляции Риша рассказал, что порой несколько классов взаимодействуют
     с одним и тем же объектом, в результате — нарушается целостность данных внутри этого
     объекта. У нас есть кот. Нужно, чтобы все экземпляры кота остались целостными, ибо никто
     не любит нецелостных котов! Знаете, что делать?
