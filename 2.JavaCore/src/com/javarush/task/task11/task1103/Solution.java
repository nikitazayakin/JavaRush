...
public class Solution {
    ...
    /**Межпланетная ферма
     ...
     Межзвёздный корабль GalaxyRush встретил на своем пути биолайнер Му-У.
     Местные фермеры — ребята неплохие, только в программировании ничего не смыслят.
     Ученики JavaRush решили им помочь и начали писать программу для учёта животных.
     Ваша часть работы — создать класс «Животное» и его наследников — «Корову»,
     «Овцу», «Быка», «Козла» и «Свинью».
     *
     * Межпланетная ферма
