...
public class Solution {
    ...
    /**Чужой код, незнакомый
     ...
     И не только будучи «джуниором». К этой непростой задачке лучше привыкать
     смолоду, и в секретном центре JavaRush это прекрасно понимают. В задаче
     переставляем наследование в классах так, чтобы она компилировалась и
     работала.
     *
     * Чужой код, незнакомый
