...
public class Solution {
    ...
    /**Хороши работнички
     ...
     Даже самый главный босс когда-то был зелёным новичком. Давайте представим,
     что вы попали на работу в должности секретаря, но мечтаете со временем быть
     управляющим. Что общего между вами, управляющим и директором?
     Все они — сотрудники. В этой задачке нужно создать класс «Сотрудник»,
     и унаследовать от него всех остальных.
