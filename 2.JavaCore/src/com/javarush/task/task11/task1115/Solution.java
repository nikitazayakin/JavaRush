...
public class Solution {
    ...
    /**От школьника до квалифицированного раба
     ...
     Сначала мы обязаны ходить в школу, потом — в университет, затем работать,
     работать, работать… пока из работника не превратимся в раба! Разумеется, это не
     наш путь, поэтому мы и учимся программировать. Пишем четыре класса и наследуем
     их друг от друга.
     *
     * От школьника до квалифицированного раба
