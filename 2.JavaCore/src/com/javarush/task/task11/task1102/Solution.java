...
public class Solution {
    ...
    /**Домашние животные
     ...
     Среди заводчиков и любителей домашних животных порой встречаются любители игуан,
     шиншилл и прочей экзотики. Но на межзвёздном корабле GalaxyRush этой самой экзотики
     и без того хватает. Так что здесь предпочитают традиционных кошечек и собачек.
     В этой задаче создаем класс Pet, записываем ему в наследники Cat и Dog.
     *
     * Домашние животные
