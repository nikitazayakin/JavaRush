...
public class Solution {
    ...
    /**ИТ-компания
     ...
     Выпускники JavaRush задумали создать стартап, связанный с написанием программ для
     одного важного космопорта. Но вот беда: им совершенно некогда писать софт для
     внутренних нужд. Поэтому наставник подключил к делу учеников второго квеста.
