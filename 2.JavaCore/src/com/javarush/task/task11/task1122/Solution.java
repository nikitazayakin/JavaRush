...
public class Solution {
    ...
    /**Помощь шахматной школе
     ...
     Мы на JavaRush любим интеллектуальные развлечения. В том числе и шахматы.
     Король и ферзь, слон, ладья и пешка — все они фигуры на доске. В этой
     задаче вам предстоит исправить дополнить чужой код, а именно — создать
     всем шахматным единицам общего родителя — фигуру.
