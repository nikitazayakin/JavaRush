...
public class Solution {
    ...
    /**Кошки не должны быть абстрактными!
     ...
     его леденящая душу история никого не оставляет равнодушным. А чтобы кошкам
     не было скучно, им нужны их заклятые друзья псы. Так что решаем задачу, где
     наследуем два неабстрактных класса Cat и Dog от Pet и пишем им методы.
     *
     * Кошки не должны быть абстрактными!
