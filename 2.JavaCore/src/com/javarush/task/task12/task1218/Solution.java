...
public class Solution {
    ...
    /**Есть, летать и двигаться
     ...
     «передвигаться» и «потреблять пищу». Добавьте их классам собаки, утки,
     автомобиля и самолёта. Руководствуясь фантазией и здравым смыслом. Иногда
     последний программисту пригождается.
     *
     * Есть, летать и двигаться
