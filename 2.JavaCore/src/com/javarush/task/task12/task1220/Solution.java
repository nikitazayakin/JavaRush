...
public class Solution {
    ...
    /**Класс Human и интерфейсы Run, Swim
     ...
     Причем, как всегда, путём написания кода. Увы. И наградим мы нашего человека
     интерфейсами «бежать» и «плавать», но не реализуем их. Ибо наш
     человек — абстрактен. Звучит понятно? Если нет, пора перечитать лекции
     по абстрактным классам и интерфейсам.
     *
     * Класс Human и интерфейсы Run, Swim
