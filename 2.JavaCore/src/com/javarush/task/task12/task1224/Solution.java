...
public class Solution {
    ...
    /**Неведома зверушка
     ...
     После ядерного взрыва прошло уже 200 лет. Животные и разумные
     формы жизни вылезли из коллекторов и снова начали плодиться и размножаться.
     Помогите разумным формам жизни составить каталог оставшихся животных.
     Среди них — «Кот», «Тигр», «Лев», «Бык», «хз» (последнее — последствие
