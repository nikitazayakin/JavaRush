...
public class Solution {
    ...
    /**Выполняем перегрузку!
     ...
     Как хорошо, что в Java существует переопределение методов! Сколько проблем это решает,
     какую свободу действий предоставляет! Так что берем его на вооружение, и продолжаем
     усваивать на практике. В этот раз давайте напишем два метода по имени print.
