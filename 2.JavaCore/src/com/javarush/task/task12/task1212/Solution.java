...
public class Solution {
    ...
    /**«Исправь код», часть 1
     ...
     Так вот, главный герой — умелый программист-новичок, которому
     предстоит разобраться с кодом нерасторопного коллеги. В конце все
     жили долго и счастливо, а программа компилируется.
