...
public class Solution {
    ...
    /**The weather is fine
     ...
     Есть класс Today. В нем нужно реализовать интерфейс Weather и метод
     getWeatherType, объявленный в интерфейсе Weather. Подумайте, как
     связан параметр type с методом getWeatherType(). Поскорее приступайте!
     ...
     2. В классе Today должен быть реализован метод getWeatherType объявленный
     в интерфейсе Weather.
