...
public class Solution {
    ...
    /**Пиво-2. Возвращение
     ...
     Пиво бывает алкогольным и безалкогольным. Разница огромна. Но независимо
     от этого главная связь человека и пива — процесс пития. В этой задаче
     будем пить только алкогольное. Подключим интерфейс Drink к классу
     AlcoholicBeer и реализуем все его методы.
     ...
     5. Программа должна выводить на экран тип напитка в зависимости от того что
