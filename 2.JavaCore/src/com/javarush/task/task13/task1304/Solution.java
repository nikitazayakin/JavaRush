...
public class Solution {
    ...
    /**Selectable и Updatable
     ...
     Инженерный отдел корабля Galaxy Rush решил создать систему наблюдения за
     планетой Диких Роботов. Ваше задание простое: создать экран, то есть класс
     Screen и реализовать в нем интерфейсы Selectable и Updatable.
     *
     * Selectable и Updatable
