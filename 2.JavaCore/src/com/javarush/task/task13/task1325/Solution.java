...
public class Solution {
    ...
    /**Компиляция программы
     ...
     У вас есть просто лисица и её наследница, большая лисица. Исправьте
     классы Fox и BigFox так, чтобы программа компилировалась. Задача не
     предполагает создания экземпляров базового класса. Метод main тоже
     лучше не трогать.
     *
     * Компиляция программы
