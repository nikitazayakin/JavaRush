...
public class Solution {
    ...
    /**Большая лисица — это такая лисица
     ...
     Большая лисица — это такая специфическая лисица, а «просто»
     лисица — это такое животное. Вот вам вкратце иерархия того,
     с чем вам предстоит работать в этой задачке. Создайте интерфейс
     Animal, класс Fox (с единственным реализованным методом getName)
