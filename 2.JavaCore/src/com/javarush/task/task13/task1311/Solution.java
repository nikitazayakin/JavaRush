...
public class Solution {
    ...
    /**Нанимаем переводчика
     ...
     который будет знатоком английского EnglishTranslator. Точнее, в рамках этой
     задачи он не будет ничего переводить, зато будет сообщать о том, с каким
     иностранным языком он работает.
     *
     * Нанимаем переводчика
     ...
     3. В классе EnglishTranslator должны быть реализованы все унаследованные от
     класса Translator абстрактные методы.
     4. Метод getLanguage должен возвращать строку, которая позволит выполнить
     условие задачи.
