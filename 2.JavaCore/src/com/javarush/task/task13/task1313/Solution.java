...
public class Solution {
    ...
    /**Лисица — это такое животное
     ...
     то она — животное, и на всю жизнь им останется? Если нет,
     значит, такому классу очень даже подойдет интерфейс «животное»,
     или Animal. Так что давайте реализуем его, параллельно выполнив
     некоторые правки в самом классе.
     *
     * Лисица — это такое животное
