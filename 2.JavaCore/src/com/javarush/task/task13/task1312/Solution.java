...
public class Solution {
    ...
    /**Код сам не исправится
     ...
     Такая маленькая программка, что и ошибиться негде… Но не тут-то было! Истинный
     программист способен выдать ошибку в любом количестве кода! Но важнее то, что
     самый лучший разработчик умеет искусно избавляться от ошибок. Исправьте код,
     чтобы программа выполнялась и выводила: «Я переводчик с английского».
     *
     * Код сам не исправится
