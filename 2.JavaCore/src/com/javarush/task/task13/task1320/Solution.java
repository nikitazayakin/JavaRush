...
public class Solution {
    ...
    /**Neo
     ...
     Давайте инициализируем пользователя номер один по имени Нео. Для этого
     реализуем интерфейс DBObject в классе User, и метод initializeIdAndName
     так, чтобы программа работала и выводила на экран «User has name Neo,
     id = 1».

     Neo
     1. Реализовать интерфейс DBObject в классе User.
     2. Реализовать метод initializeIdAndName так, чтобы программа работала и
     выводила на экран "User has name Neo, id = 1".
