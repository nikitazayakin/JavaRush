...
public class Solution {
    ...
    /**Это кто там такой умный?
     ...
     Знаете разницу между Smart и Clever? Мы тоже, но речь не об этом, а
     о добавлении интерфейсов. Secretary и Boss к классам CleverMan и SmartGirl.
     Какой интерфейс какому классу лучше подходит, попробуйте подобрать
     ...
     * Это кто там такой умный?
     ...
     чтобы все методы у классов CleverMan и SmartGirl оказались объявленными в
     каком-то интерфейсе.
