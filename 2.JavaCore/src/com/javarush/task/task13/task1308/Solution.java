...
public class Solution {
    ...
    /**Эй, ты там живой?
     ...
     Ответ на этот вопрос должна выдавать программа, которую вам предстоит
     написать. Для этого создайте интерфейс Person и добавьте в него метод
     isAlive(), который должен будет сообщать о наличии признаков жизни объекта
     Person. Догадаетесь, результат какого типа должен возвращать этот метод?
     *
     * Эй, ты там живой?
