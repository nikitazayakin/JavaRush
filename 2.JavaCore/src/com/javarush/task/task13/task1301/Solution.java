...
public class Solution {
    ...
    /**Пиво
     ...
     Много программирования не бывает… А вот у ситуации «много пива» бывают последствия
     «пора домой» или «спать на полу». В задачке вы получите два интерфейса, и один из
     них нужно будет реализовать в классе Beer, и, вместе с тем — разобраться со связью
     переменной READY_TO_GO_HOME и метода isReadyToGoHome.
     *
     * Пиво
     ...
     2. Класс Beer не должен реализовывать интерфейс Drink напрямую(только опосредованно
     через Alcohol)
